...
const ProfessionalJourney = () => {
  return (
    <section id="journey" className="py-32 bg-gradient-to-b from-deep-black to-near-black">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-8">
                  ...
                  Excited to contribute to productivity solutions that empower billions of users worldwide.
                </p>
              </div>
              <motion.div
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="text-alexa-blue font-mono text-sm tracking-wider">COMPLETED</div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Implemented a push-based, event-driven billing system handling high-volume device metering data with fault-tolerant processing.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-alexa-blue rounded-full mt-2 flex-shrink-0" />
                    <p className="text-gray-300 text-sm leading-relaxed">
                     Wrote comprehensive unit tests with 100% coverage for business-critical logic, including failure and retry scenarios. 
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-alexa-blue rounded-full mt-2 flex-shrink-0" />
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Delivered production-ready code aligned with enterprise billing standards and operational requirements.
                    </p>
                  </div>
                </div>
                
                <div className="flex flex-wrap gap-2">
                  {['AWS Lambda', 'DynamoDB', 'S3', 'CDK', 'Java',].map((tech) => (
                    <span key={tech} className="px-3 py-1.5 bg-alexa-blue/10 text-alexa-blue border border-alexa-blue/20 rounded-md text-xs font-medium">
                      {tech}
                    </span>
                  ))}
                </div>
